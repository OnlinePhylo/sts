#ifndef STS_MOVES_EXPONENTIAL_BRANCH_LENGTH_PROPOSER_H
#define STS_MOVES_EXPONENTIAL_BRANCH_LENGTH_PROPOSER_H
...
#endif // STS_MOVES_EXPONENTIAL_BRANCH_LENGTH_PROPOSER_H
