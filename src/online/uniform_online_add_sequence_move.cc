...
UniformOnlineAddSequenceMove::UniformOnlineAddSequenceMove(std::vector<std::unique_ptr<CompositeTreeLikelihood>>& calculator,
...
AttachmentProposal UniformOnlineAddSequenceMove::propose(const std::string& leafName, smc::particle<TreeParticle>& particle, smc::rng* rng)
{
    ...
    return AttachmentProposal {n, 0.0, distal, 0.0, pendant, pendantLogDensity, 0.0, 0.0, 0.0, "UniformOnlineAddSequenceMove"};
}
