#ifndef STS_ONLINE_UNIFORM_ONLINE_ADD_SEQUENCE_MOVE_H
#define STS_ONLINE_UNIFORM_ONLINE_ADD_SEQUENCE_MOVE_H
...
/// \f]
class UniformOnlineAddSequenceMove : public OnlineAddSequenceMove
{
public:
    /// Constructor
    ///
	...
	UniformOnlineAddSequenceMove(std::vector<std::unique_ptr<CompositeTreeLikelihood>>& calculator,
...
#endif // STS_ONLINE_UNIFORM_ONLINE_ADD_SEQUENCE_MOVE_H
