...
TEST_CASE("parsing/newick_parsing/one_leaf", "test parsing a newick tree with one leaf")
{
    std::string tree = "A;";
...
TEST_CASE("parsing/newick_parsing/two_leaf", "test parsing a newick tree with two leaves")
{
...
TEST_CASE("parsing/newick_parsing/three_leaf", "test parsing a newick tree with three leaves")
{
...
TEST_CASE("parsing/newick_parsing/four_leaf", "test parsing a newick tree with four leaves")
{
...
TEST_CASE("parsing/newick_parsing/round_trip/1", "test a parsed newick tree can round-trip")
{
    std::string tree = "((A:2,B:3):4,(C:6,D:7):9);\n";
...
TEST_CASE("parsing/newick_parsing/round_trip/2", "test a parsed newick tree can round-trip")
{
