...
{
    std::function<double(double)> *func = (std::function<double(double)>*)(data);
    return (*func)(d);
}

double minimize(const std::function<double(double)> fn, double m=0.5, double a=0, double b=1, const int max_iter=100,
